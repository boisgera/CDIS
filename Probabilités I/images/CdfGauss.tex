...
\addplot[black, very thick, samples = 200] {normcdf(x,0,1)};
%
\addplot[black!50, very thick, samples = 200] {normcdf(x,0,5)};
%
\addplot[MPTblue, very thick, samples = 200] {normcdf(x,5,1)};
%
